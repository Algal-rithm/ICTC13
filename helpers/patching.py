...
# ========== EXAMPLE ==========
# python3 patching.py -s /home/researcher/exp1/NodHar_1 -d /home/researcher/exp1/NodHar_1_448 -y 448 -x 448 -v 0 -z 0
    ...
    parser.add_argument("-d", "--dest",
                        help="the destination directory (will make it if it doesn't exist, wipe it if it does)")
